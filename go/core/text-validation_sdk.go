...
func (sdk *TextValidationSDK) OptionsMap() map[string]any {
...
func (sdk *TextValidationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TextValidationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TextValidationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TextValidationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TextValidationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TextValidationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TextValidationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TextValidationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TextValidationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TextValidationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TextValidationSDK {
	...
	sdk := NewTextValidationSDK(sdkopts)
	sdk.Mode = "test"
