...
// instead of `sdk.NewTextValidationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *TextValidationSDK  { return NewTextValidationSDK(nil) }
func Test() *TextValidationSDK { return TestSDK(nil, nil) }
