...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.TextValidationSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.TextValidationSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
