...
// TextValidation SDK pipeline test
//
...
{
    private static function utility(): TextValidationUtility
    {
        return new TextValidationUtility();
    }
    ...
    private static function ctx(array $over = []): TextValidationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TextValidationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TextValidationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TextValidationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TextValidationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TextValidationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TextValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TextValidationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TextValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TextValidationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TextValidationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TextValidationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TextValidationResponse([]),
            'result' => new TextValidationResult([]),
        ]);
        [, $err] = TextValidationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TextValidationSpec([]),
            'response' => null,
            'result' => new TextValidationResult([]),
        ]);
        [, $err] = TextValidationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TextValidationSpec(['step' => 's']),
            'response' => new TextValidationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TextValidationResult([]),
        ]);
        [, $err] = TextValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TextValidationSpec(['step' => 's']),
            'response' => new TextValidationResponse(self::resp(200, ['v' => 1])),
            'result' => new TextValidationResult([]),
        ]);
        [, $err] = TextValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TextValidationSpec(['step' => 's']),
            'response' => new TextValidationResponse(self::resp(200, ['v' => 2])),
            'result' => new TextValidationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TextValidationMakeResponse::call($ctx);
    ...
    {
        $preset = new TextValidationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TextValidationSpec([]),
            'response' => new TextValidationResponse([]),
            'result' => new TextValidationResult([]),
        ...
        [$got, $err] = TextValidationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TextValidationResult([])]);
        [, $err] = TextValidationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TextValidationSpec([]), 'result' => null]);
        [, $err] = TextValidationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TextValidationSpec(['step' => 's']),
            'result' => new TextValidationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TextValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TextValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TextValidationSpec(['step' => 's']),
            'result' => new TextValidationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TextValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TextValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TextValidationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TextValidationSpec([]),
            'result' => new TextValidationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TextValidationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TextValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TextValidationError('boom', 'boom');
        $utility->fetcher = function (TextValidationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TextValidationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TextValidationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TextValidationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TextValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TextValidationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TextValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TextValidationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TextValidationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TextValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TextValidationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TextValidationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TextValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TextValidationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TextValidationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TextValidationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TextValidationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TextValidationResult(['ok' => false])]);
        $this->expectException(TextValidationError::class);
        TextValidationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TextValidationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TextValidationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TextValidationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TextValidationBaseFeature();
        $b = new TextValidationBaseFeature();
        TextValidationFeatureAdd::call($ctx, $a);
        TextValidationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TextValidationBaseFeature
    {
        $f = new TextValidationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TextValidationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TextValidationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TextValidationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TextValidationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TextValidationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TextValidationResponse(['headers' => null]),
            'result' => new TextValidationResult([]),
        ]);
        TextValidationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TextValidationResultBody::call($ctx);
