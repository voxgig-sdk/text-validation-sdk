...
// TextValidation SDK audit feature
...
class TextValidationAuditFeature extends TextValidationBaseFeature
{
    ...
    private function _emit(TextValidationContext $ctx, string $outcome): void
    {
