...
// TextValidation SDK rbac feature
...
class TextValidationRbacFeature extends TextValidationBaseFeature
{
    ...
    private function _required(TextValidationContext $ctx): ?string
    {
    ...
    private function _reject(TextValidationContext $ctx, string $required): void
    {
    ...
    private function _track(TextValidationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
