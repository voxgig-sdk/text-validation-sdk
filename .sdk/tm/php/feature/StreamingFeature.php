...
// TextValidation SDK streaming feature
...
class TextValidationStreamingFeature extends TextValidationBaseFeature
{
    ...
    private function _iterate(TextValidationResult $result): \Generator
    {
    ...
    private function _streamable(TextValidationContext $ctx): bool
    {
