...
// TextValidation SDK netsim feature
...
class TextValidationNetsimFeature extends TextValidationBaseFeature
{
    ...
    private function _simulate(TextValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TextValidationContext $ctx, array $applied): void
    {
        $client = $this->client;
