...
// TextValidation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TextValidationTransformResponse
{
    public static function call(TextValidationContext $ctx): mixed
    {
        ...
        $transform = TextValidationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
