...
// TextValidation SDK utility: fetcher

class TextValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TextValidationSDK/1.0)';
    ...
    public static function call(TextValidationContext $ctx, string $fullurl, array $fetchdef): array
    {
