...
from projectname_sdk.core.control import TextValidationControl
...
class TextValidationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TextValidationControl()
        ...
        if isinstance(sp, TextValidationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TextValidationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TextValidationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TextValidationOperation({})
    ...
    def make_error(self, code, msg):
        return TextValidationError(code, msg, self)
