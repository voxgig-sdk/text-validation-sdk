...
class TextValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TextValidationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TextValidationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TextValidationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
