...
class TextValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TextValidationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TextValidationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TextValidationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
