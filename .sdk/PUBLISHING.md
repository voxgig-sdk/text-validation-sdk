...
|---|---|---|
| `ts/` | @voxgig-sdk/text-validation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/text-validation-sdk \
      --repository voxgig-sdk/text-validation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/text-validation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/text-validation-sdk --id=<id>` removes it.
