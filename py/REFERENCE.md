# TextValidation Python SDK Reference

Complete API reference for the TextValidation Python SDK.
...
#### `TextValidationSDK.test(testopts=None, sdkopts=None)`
...
```python
result = client.Validation().load({"text": "text"})
```
