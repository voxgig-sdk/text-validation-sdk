# TextValidation Python SDK



The Python SDK for the TextValidation API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/text-validation-sdk/releases)) or
...
```python
client = TextValidationSDK.test(testopts, sdkopts)
```
...
```
py/
├── textvalidation_sdk.py         -- Main SDK module
...
The main module (`textvalidation_sdk`) exports the SDK class.
