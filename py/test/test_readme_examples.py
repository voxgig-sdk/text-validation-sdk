# TextValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TextValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TextValidationSDK(...) and TextValidationSDK.test(...) become
#      TextValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "textvalidation_sdk"
_SDK_CLASS = "TextValidationSDK"
