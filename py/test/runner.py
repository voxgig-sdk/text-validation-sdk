...
class TextValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TextValidationTestRunner.getenv("TEXTVALIDATION_TEST_LIVE")
        override = TextValidationTestRunner.getenv("TEXTVALIDATION_TEST_OVERRIDE")
        ...
        explain = TextValidationTestRunner.getenv("TEXTVALIDATION_TEST_EXPLAIN")
