...
from textvalidation_sdk.utility import register

# Load features
from textvalidation_sdk.feature.base_feature import TextValidationBaseFeature
from textvalidation_sdk.features import _has_feature, _make_feature
...
class TextValidationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TextValidationUtility()
        self._utility = utility

        from textvalidation_sdk.config import shared_config
    ...
    def get_utility(self):
        return TextValidationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TextValidationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Validation(self, data=None) -> "ValidationEntity":
        ...
        from textvalidation_sdk.entity.validation_entity import ValidationEntity
        return ValidationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TextValidationSDK":
        if sdkopts is None:
            sdkopts = {}
