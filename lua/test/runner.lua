...
function runner.env_override(m)
  local live = runner.getenv("TEXTVALIDATION_TEST_LIVE")
  local override = runner.getenv("TEXTVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TEXTVALIDATION_TEST_EXPLAIN")
