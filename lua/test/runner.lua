...
function runner.env_override(m)
  local live = runner.getenv("TEXT_VALIDATION_TEST_LIVE")
  local override = runner.getenv("TEXT_VALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TEXT_VALIDATION_TEST_EXPLAIN")
