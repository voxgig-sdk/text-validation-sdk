...
func registerTools(server *mcp.Server, client *sdk.TextValidationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "text-validation_list",
		Description: "List records from TextValidation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "text-validation_load",
		Description: "Load a single record from TextValidation. " +
...
func runOp(client *sdk.TextValidationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TextValidationSDK, name string) (sdk.TextValidationEntity, error) {
