// Command TextValidation-mcp is an MCP server exposing the TextValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TextValidation_list  — list records of an entity
//	TextValidation_load  — load a single record of an entity
//
