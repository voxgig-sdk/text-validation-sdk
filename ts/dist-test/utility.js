...
function envOverride(m) {
    if ('TRUE' === process.env.TEXT_VALIDATION_TEST_LIVE ||
        'TRUE' === process.env.TEXT_VALIDATION_TEST_OVERRIDE) {
    ...
    m.TEXT_VALIDATION_TEST_EXPLAIN = process.env.TEXT_VALIDATION_TEST_EXPLAIN || m.TEXT_VALIDATION_TEST_EXPLAIN;
    return m;
}
