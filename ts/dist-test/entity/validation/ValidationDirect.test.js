...
(0, node_test_1.describe)('ValidationDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('TEXT_VALIDATION_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TextValidationSDK({
    ...
    (0, node_test_1.test)('direct-load-validation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-validation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TEXT_VALIDATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TextValidationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TEXT_VALIDATION_TEST_VALIDATION_ENTID'];
    ...
    const client = new __1.TextValidationSDK({
        base: 'http://localhost:8080',
