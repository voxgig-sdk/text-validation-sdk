...
func registerSDKWords(r *eng.Registry, client *sdk.TextValidationSDK) {
...
func runOp(client *sdk.TextValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
