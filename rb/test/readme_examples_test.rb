...
#      offline in seeded test mode (TextValidationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TextValidation_sdk.rb")
  SDK_CLASS = "TextValidationSDK"
