...
// TextValidation SDK timeout feature
...
class TextValidationTimeoutFeature extends TextValidationBaseFeature
{
    ...
    private function _with_timeout(TextValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TextValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;
