...
// TextValidation SDK telemetry feature
...
class TextValidationTelemetryFeature extends TextValidationBaseFeature
{
    ...
    private function _close(TextValidationContext $ctx, bool $ok): void
    {
