...
// TextValidation SDK cache feature
...
class TextValidationCacheFeature extends TextValidationBaseFeature
{
    ...
    private function _through(TextValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
