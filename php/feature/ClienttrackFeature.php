...
// TextValidation SDK clienttrack feature
...
class TextValidationClienttrackFeature extends TextValidationBaseFeature
{
    ...
    public function PostConstruct(TextValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TextValidation-SDK';
