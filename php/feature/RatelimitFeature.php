...
// TextValidation SDK ratelimit feature
...
class TextValidationRatelimitFeature extends TextValidationBaseFeature
{
    ...
    private function _acquire(TextValidationContext $ctx): void
    {
    ...
    private function _track(TextValidationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
