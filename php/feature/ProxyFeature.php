...
// TextValidation SDK proxy feature
...
class TextValidationProxyFeature extends TextValidationBaseFeature
{
    ...
    public function init(TextValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TextValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
