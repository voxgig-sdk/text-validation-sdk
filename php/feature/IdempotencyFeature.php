...
// TextValidation SDK idempotency feature
...
class TextValidationIdempotencyFeature extends TextValidationBaseFeature
{
    ...
    private function _mutating(TextValidationContext $ctx): bool
    {
