...
// TextValidation SDK debug feature
...
class TextValidationDebugFeature extends TextValidationBaseFeature
{
    ...
    private function _finish(TextValidationContext $ctx, bool $ok): void
    {
