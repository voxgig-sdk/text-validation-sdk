...
// TextValidation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TextValidationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TextValidationOmni::structfix($now, Struct::undef()))
                        !== json_encode(TextValidationOmni::structfix($val, Struct::undef()))) {
