...
// TextValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TextValidationSDK::test)
...
{
    private const SDK_CLASS = 'TextValidationSDK';
    ...
    private const SDK_BASE = 'textvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../textvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
