# TextValidation PHP SDK

The PHP SDK for the TextValidation API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->TextValidation(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── textvalidation_sdk.php          -- Main SDK class
...
The main class (`textvalidation_sdk.php`) exports the SDK class
