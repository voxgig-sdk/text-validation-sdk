...
// TextValidation SDK utility type

class TextValidationUtility
{
    ...
    public static function copy(TextValidationUtility $src): TextValidationUtility
    {
        $u = new TextValidationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
