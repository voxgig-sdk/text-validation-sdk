...
// TextValidation SDK utility: graphql
//
...
class TextValidationGraphql
{
    ...
    // equivalent.
    public static function body(TextValidationContext $ctx): mixed
    {
    ...
    public static function errors(TextValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
