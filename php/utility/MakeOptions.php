...
// TextValidation SDK utility: make_options

class TextValidationMakeOptions
{
    ...
    public static function call(TextValidationContext $ctx): array
    {
        ...
        //
        // `TextValidationSchema::optspec()` is built from the model:
        ...
        $optspec = TextValidationSchema::optspec();
